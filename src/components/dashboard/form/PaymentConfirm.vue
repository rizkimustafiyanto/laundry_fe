<template>
    <BaseModal
      v-model="modelValue"
      :title="'Konfirmasi Pembayaran Transaksi'"
      size="md"
    >
      ...
      >
        ...
        <section v-if="form.payment" class="mt-4">
          ...
          >
            ...
            <p class="text-xs mt-1">
              ...
              <span v-if="form.payment.paidAt">• Dikonfirmasi: {{ formatDate(form.payment.paidAt, 'dd MMM yyyy, HH:mm') }}</span>
            </p>
          </div>
        </section>
        ...
        <section class="space-y-3">
          ...
          <!-- Tombol Konfirmasi -->
          <BaseButton
            :label="adminStatus === 'PAID' ? 'Konfirmasi Pembayaran Berhasil' : 'Tandai Sebagai Gagal'"
